...
export default class Index extends Component {
  ...
  static navigationOptions = ({ navigation }) => {
    return {
      ...
      headerRight:
        navigation.getParam("userId") == navigation.getParam("roomUserId") ? (
          <TouchableOpacity
            onPress={navigation.getParam("_handleDelete")}
  ...
  render() {
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        <ImageBackground
          source={{
            uri: "https://i.pinimg.com/564x/bd/df/04/bddf04ab2f81d93aa0e32a417879e904.jpg",
          }}
